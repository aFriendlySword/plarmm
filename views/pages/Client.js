run = function () {
    ...
    addMap = function (height, width, data, maxscore) {
        map = {
            height: height,
            width: width,
            data: data,
    ...
    addMap(20, 100, "", 20);
    addMap(50, 80, "", 0);
    ...
    saveStats = function (map) {
        if (runtime < user.times[map] || user.times[map] == 0) {
            user.times[map] = runtime;
            runtime = 0;
        }
        if (user.score[map] < user.coins) {
            user.score[map] = user.coins;
        }
    }
